...
export class AddedFavorites1682287781572 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "favorite" ("id" SERIAL NOT NULL, "id_actividad" integer NOT NULL, "es_plan" boolean NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "id_usuario" integer, CONSTRAINT "PK_495675cec4fb09666704e4f610f" PRIMARY KEY ("id"))`);
