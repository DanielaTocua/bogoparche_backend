...
export class DeleteEventIdPlanIdFromActivity1683473032208
	implements MigrationInterface
{
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(
			`ALTER TABLE "activity" DROP CONSTRAINT "REL_12c101cb84aae626b8f4cd30f5"`,
		);
		await queryRunner.query(`ALTER TABLE "activity" DROP COLUMN "eventId"`);
		await queryRunner.query(
			`ALTER TABLE "activity" DROP CONSTRAINT "REL_ccab3cfce9d3f1f834a3494b27"`,
		);
	...
	public async down(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(
			`ALTER TABLE "activity" ADD CONSTRAINT "REL_ccab3cfce9d3f1f834a3494b27" UNIQUE ("planId")`,
		);
		await queryRunner.query(`ALTER TABLE "activity" ADD "eventId" integer`);
		await queryRunner.query(
			`ALTER TABLE "activity" ADD CONSTRAINT "REL_12c101cb84aae626b8f4cd30f5" UNIQUE ("eventId")`,
		);
		await queryRunner.query(
