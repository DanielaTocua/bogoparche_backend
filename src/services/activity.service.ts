...
export const findAll = async (): Promise<QueryResult<any>> => {
    ...
    const result = client.query(`SELECT id_actividad, titulo_actividad, ubicacion, rango_precio, descripcion, restriccion_edad, medio_contacto FROM plan WHERE es_privada IS false
    UNION
